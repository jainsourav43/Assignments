...
//		 if(t1&&t2&&t3)
//		 {
//		  ma[make_pair(ch[p],make_pair(kelement[1],kelement[2]))]=0;
//		 }
//	 }
//	}
auto ti=ma.begin();
...
//		{
//			for( q=p+1;1<curr.size();q++)
//			{
//				for( r=0;r<curr[p].size()-1;r++)
//				{
//					kelement.push_back(curr[p][r]);
//				}
//					kelement.push_back(curr[p][r]);
//					kelement.push_back(curr[q][r]);
//					finalcurr.push_back(kelement);
//			}
//		}
//		
